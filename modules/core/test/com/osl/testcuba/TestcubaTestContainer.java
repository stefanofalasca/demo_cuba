...
public class TestcubaTestContainer extends TestContainer {

    public TestcubaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/osl/testcuba/app.properties",
    ...
    public static class Common extends TestcubaTestContainer {

        public static final TestcubaTestContainer.Common INSTANCE = new TestcubaTestContainer.Common();
